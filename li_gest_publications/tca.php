...
if($admin == "1")
{
	$Publication = 'hidden;;1;;1-1-1,';
	$Theme_Publication = 'hidden;;1;;1-1-1, idPublication,';
	$Theme = 'hidden;;1;;1-1-1,';
...
$TCA["tx_ligestpublications_Publication"] = array (
	...
	"interface" => array (
		"showRecordFieldList" => "hidden, Titre, TypePublication, TypeDiffusion, TypeContribution, EstEditeur, EstInternationale, EstInvite, EstDeLaVulgarisation, Pages, EstParu, TauxAcceptation, MediaDePublication, ISBN, Notes, PublisherOrSchool, Volume, Serie, Numero, Edition, Annee, DateDebut, DateFin, VilleEtPays, Lien, Afficher_Themes, Afficher_Equipes, Afficher_Auteurs, Afficher_Fichiers"
	),
	...
	"columns" => array (
			...
			"config" => Array (
				...
				"wizards" => Array(
					...
					"add" => Array(
                        ...
                        "icon" => "add.gif",
                        "params" => Array(
                            "table"=>"tx_ligestpublications_TypePublication",
                            "pid" => "###CURRENT_PID###",
                            "setValue" => "prepend"
                        ),
		...
		"EstInternationale" => Array (		
			...
			"config" => Array (
				"type" => "select",
				"items" => Array (
					Array("LLL:EXT:li_gest_publications/locallang_db.xml:tx_ligestpublications_Publication.estinternationale.I.0", "N"),
					Array("LLL:EXT:li_gest_publications/locallang_db.xml:tx_ligestpublications_Publication.estinternationale.I.1", "I"),
					Array("LLL:EXT:li_gest_publications/locallang_db.xml:tx_ligestpublications_Publication.estinternationale.I.2", "F"),
				),
				"size" => 1,	
				"maxitems" => 1,
				'default' => 'I'
		...
		"TypeContribution" => Array (		
			"exclude" => 1,
			'l10n_display' => 'defaultAsReadonly',
			"label" => "LLL:EXT:li_gest_publications/locallang_db.xml:tx_ligestpublications_Publication.TypeContribution",		
			"config" => Array (
				"type" => "select",
				"items" => Array (
					//Array("LLL:EXT:li_gest_publications/locallang_db.xml:tx_ligestpublications_Publication.TypeContribution.I.0", "R"),
					Array("LLL:EXT:li_gest_publications/locallang_db.xml:tx_ligestpublications_Publication.TypeContribution.I.1", "P"),
					Array("LLL:EXT:li_gest_publications/locallang_db.xml:tx_ligestpublications_Publication.TypeContribution.I.2", "E"),
				),
				"size" => 1,	
				"maxitems" => 1,
			)
		...
		"TypeDiffusion" => Array (		
			"exclude" => 1,
			'l10n_display' => 'defaultAsReadonly',	
			"label" => "LLL:EXT:li_gest_publications/locallang_db.xml:tx_ligestpublications_Publication.typediffusion",		
			"config" => Array (
				"type" => "select",
				"items" => Array (
					Array("LLL:EXT:li_gest_publications/locallang_db.xml:tx_ligestpublications_Publication.typediffusion.I.0", "L"),
					Array("LLL:EXT:li_gest_publications/locallang_db.xml:tx_ligestpublications_Publication.typediffusion.I.1", "R"),
				),
				"size" => 1,	
				"maxitems" => 1,
				'default' => 'L'
		...
		"TauxAcceptation" => Array (		
			"exclude" => 1,
			'l10n_display' => 'defaultAsReadonly',
			"label" => "LLL:EXT:li_gest_publications/locallang_db.xml:tx_ligestpublications_Publication.TauxAcceptation",		
			"config" => Array (
				"type" => "input",	
				"size" => "30",	
				"max" => "255",	
		...
		"TitreSupport" => Array (		
			"exclude" => 1,
			'l10n_mode' => 'mergeIfNotBlank',
			"label" => "LLL:EXT:li_gest_publications/locallang_db.xml:tx_ligestpublications_Publication.TitreSupport",		
			"config" => Array (
				"type" => "input",	
				"size" => "30",	
				"max" => "255",	
		...
		"DOI" => Array (
			"exclude" => 1,
			'l10n_display' => 'defaultAsReadonly',
			"label" => "LLL:EXT:li_gest_publications/locallang_db.xml:tx_ligestpublications_Publication.DOI",		
			"config" => Array (
				"type" => "input",	
				"size" => "30",	
				"max" => "255",	
	...
	"types" => array (
		"0" => array("showitem" => $Publication."Titre,  TypePublication, TypeDiffusion, TypeContribution, EstEditeur, EstInternationale, EstInvite, EstDeLaVulgarisation, EstParu, TauxAcceptation, Annee, DateDebut, DateFin, TitreSupport, Pages, MediaDePublication, ISBN, DOI, PublisherOrSchool, Volume, Serie, Numero, Edition, VilleEtPays, Lien, Notes,  Afficher_Themes, Afficher_Equipes, Afficher_Auteurs, Afficher_Fichiers")
	),
	"palettes" => array (
		"1" => array("showitem" => "")
	)
...
$TCA["tx_ligestpublications_Theme_Publication"] = array (
	...
	"types" => array (
		"0" => array("showitem" => $Theme_Publication."idTheme")
	),
	"palettes" => array (
		"1" => array("showitem" => "")
	)
...
$TCA["tx_ligestpublications_Theme"] = array (
	...
	"types" => array (
		"0" => array("showitem" => $Theme."sys_language_uid, l18n_parent, l18n_diffsource, Libelle")
	),
	"palettes" => array (
		"1" => array("showitem" => "")
	)
...
$TCA["tx_ligestpublications_Appartenir"] = array (
	...
	"types" => array (
		"0" => array("showitem" => $Appartenir."idEquipe")
	),
	"palettes" => array (
		"1" => array("showitem" => "")
	)
...
$TCA["tx_ligestpublications_Fichier"] = array (
	...
	"types" => array (
		"0" => array("showitem" => $Fichier."NomFichier, LienFichier, fe_group")
	),
	"palettes" => array (
		"1" => array("showitem" => "")
	)
...
$TCA["tx_ligestpublications_TypePublication"] = array (
	...
	"types" => array (
		"0" => array("showitem" => $TypePublication."sys_language_uid, l18n_parent, l18n_diffsource, Code, Libelle")
	),
	"palettes" => array (
		"1" => array("showitem" => "")
	)
