...
CREATE TABLE tx_ligestpublications_Publication (
	...
	TypeContribution char(1) DEFAULT '' NOT NULL,
	EstDeLaVulgarisation char(1) DEFAULT '' NOT NULL,
	TypeDiffusion char(1) DEFAULT '' NOT NULL,
	...
	TauxAcceptation varchar(255) DEFAULT '' NOT NULL,
	TitreSupport varchar(255) DEFAULT '' NOT NULL,
...
CREATE TABLE tx_ligestpublications_Publication_Auteur (
	...
	Ordre int(11) DEFAULT '1' NOT NULL,
