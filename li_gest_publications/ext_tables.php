...
$tempColumns = Array (
	"Afficher_auteur" => Array (		
		...
		"config" => Array (
			...
			"foreign_table_where" => "AND tx_ligestpublications_Auteur.idMembreLabo=###THIS_UID### ORDER BY tx_ligestpublications_Auteur.Nom DESC",
			"size" => 6,
			"minitems" => 0,
			"maxitems" => 1,
			"wizards" => Array(
...
$TCA["tx_ligestpublications_Theme_Publication"] = array (
	"ctrl" => array (
		...
		'label'     => 'idPublication, idTheme',
		'label_alt' => 'idPublication, idTheme',
		'label_alt_force' => '1',
		'tstamp'    => 'tstamp',
		'crdate'    => 'crdate',
		'cruser_id' => 'cruser_id',
...
$TCA["tx_ligestpublications_Auteur"] = array (
	"ctrl" => array (
		...
		'label'     => 'Nom, Prenom, idMembreLabo',
		'label_alt' => 'Nom, Prenom, idMembreLabo',
		'label_alt_force' => '1',
		'tstamp'    => 'tstamp',
		'crdate'    => 'crdate',
		'cruser_id' => 'cruser_id',
