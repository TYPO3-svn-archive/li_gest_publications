...
class tx_ligestpublications_pi1 extends tslib_pibase {
	...
	function main($content,$conf)	{
		...
		if(($this->lConf['requete'])<>true){
			...
			$publicationdepuis= $this->lConf['limitationdatedebut'];
			...
			$publicationjusquen= $this->lConf['limitationdatefin'];
			
			if($publicationjusquen<>false)
			{
				$where = $where.' AND ((year(tx_ligestpublications_Publication.DateFin)<="'.$publicationjusquen.'" AND tx_ligestpublications_Publication.DateFin<>"0000-00-00") OR (tx_ligestpublications_Publication.Annee<='.$publicationjusquen.'))';
			}
			...
			if($internationale=="Est nationale")
			{
				$where = $where.' AND tx_ligestpublications_Publication.EstInternationale="N"';
			}
			else if($internationale=="Est internationale")
			{
				$where = $where.' AND tx_ligestpublications_Publication.EstInternationale="I"';
			}
			else if($internationale=="Est internationale francophone")
			{
				$where = $where.' AND tx_ligestpublications_Publication.EstInternationale="F"';
			}
			...
			$chapitre = $this->lConf['typecontribution'];

			if($chapitre=="Acte ou livre ou revue")
			{
				$where = $where.' AND tx_ligestpublications_Publication.TypeContribution="E"';
			}
			else if($chapitre=="Article ou chapitre")
			{
				$where = $where.' AND tx_ligestpublications_Publication.TypeContribution="P"';
			}
		...
		while($row = $GLOBALS['TYPO3_DB']->sql_fetch_assoc($res)){
			...
			if($row['EstInternationale']=='N'){
			...
			else if($row['EstInternationale']=='I'){
				...
				$markerArray_publications_par_titres_publications['###EstInternationale###'] = $this->lConf['EstInternationaleFrancophone'];
				
				if($this->lConf['EstInternationaleFrancophone']<>''){
					$markerArray_publications_par_titres_publications['###EstInternationale_Separateur###'] = $this->lConf['EstInternationale_Separateur'];
				}
				else{
					$markerArray_publications_par_titres_publications['###EstInternationale_Separateur###'] = '';
			...
			if($row['TypeContribution']=='E'){
				$markerArray_publications_par_titres_publications['###TypeContribution###'] = $this->lConf['TypeContributionE'];
				
				if($this->lConf['TypeContributionE']<>''){
					$markerArray_publications_par_titres_publications['###TypeContribution_Separateur###'] = $this->lConf['TypeContribution_Separateur'];
				}
				else{
					$markerArray_publications_par_titres_publications['###TypeContribution_Separateur###'] = '';
				}
			}
			else{
				$markerArray_publications_par_titres_publications['###TypeContribution###'] = $this->lConf['TypeContributionP'];
				
				if($this->lConf['TypeContributionP']<>''){
					$markerArray_publications_par_titres_publications['###TypeContribution_Separateur###'] = $this->lConf['TypeContribution_Separateur'];
				}
				else{
					$markerArray_publications_par_titres_publications['###TypeContribution_Separateur###'] = '';
			...
			$markerArray_publications_par_titres_publications['###TitreSupport###'] = $row['TitreSupport'];
			if($row['TitreSupport']<>''){
				$markerArray_publications_par_titres_publications['###TitreSupport_Separateur###'] = $this->lConf['TitreSupport_Separateur'];
			}
			else{
				$markerArray_publications_par_titres_publications['###TitreSupport_Separateur###'] = '';
			}
			...
			$markerArray_publications_par_titres_publications['###DOI###'] = $row['DOI'];
			if($row['DOI']<>''){
				$markerArray_publications_par_titres_publications['###DOI_Separateur###'] = $this->lConf['DOI_Separateur'];
			}
			else{
				$markerArray_publications_par_titres_publications['###DOI_Separateur###'] = '';
			}
			...
			if($row['TauxAcceptation']<>''){
				$markerArray_publications_par_titres_publications['###TauxAcceptation###'] = $row['TauxAcceptation'].'%';
				$markerArray_publications_par_titres_publications['###TauxAcceptation_Separateur###'] = $this->lConf['TauxAcceptation_Separateur'];
			}
			else{
				$markerArray_publications_par_titres_publications['###TauxAcceptation###'] = '';
				$markerArray_publications_par_titres_publications['###TauxAcceptation_Separateur###'] = '';
			}
			...
			//**************************************
				...
				$auteurs_select_fields = "tx_ligestpublications_Auteur.uid AS uidAuteur, tx_ligestpublications_Auteur.*, tx_ligestpublications_Publication.*, tx_ligestpublications_Publication_Auteur.*";
				$auteurs_from_table = "tx_ligestpublications_Auteur, tx_ligestpublications_Publication, tx_ligestpublications_Publication_Auteur";
				...
				while($auteurs_row = $GLOBALS['TYPO3_DB']->sql_fetch_assoc($auteurs_res)){
					$idAuteur = $auteurs_row['uidAuteur'];
					...
					$membres_select_fields = "tx_ligestpublications_Auteur.uid AS uidAuteur, tx_ligestpublications_Auteur.*, tx_ligestpublications_Publication.*, tx_ligestpublications_Publication_Auteur.*, tx_ligestmembrelabo_MembreDuLabo.PageWeb, tx_ligestmembrelabo_Equipe.uid AS uidequipe";
					$membres_from_table = "tx_ligestpublications_Auteur, tx_ligestpublications_Publication, tx_ligestpublications_Publication_Auteur, tx_ligestmembrelabo_MembreDuLabo, tx_ligestmembrelabo_Equipe, tx_ligestmembrelabo_EstMembreDe";
					$membres_where_clause = "tx_ligestpublications_Auteur.uid = ".$idAuteur." AND tx_ligestpublications_Publication.uid = ".$uid." AND tx_ligestpublications_Publication.uid = tx_ligestpublications_Publication_Auteur.idPublication AND tx_ligestpublications_Publication_Auteur.deleted<>1 AND tx_ligestpublications_Publication_Auteur.idAuteur = tx_ligestpublications_Auteur.uid AND tx_ligestpublications_Auteur.deleted<>1 AND tx_ligestpublications_Auteur.idMembreLabo = tx_ligestmembrelabo_MembreDuLabo.uid AND tx_ligestmembrelabo_MembreDuLabo.deleted<>1 AND tx_ligestmembrelabo_MembreDuLabo.uid = tx_ligestmembrelabo_EstMembreDe.idMembreLabo AND tx_ligestmembrelabo_EstMembreDe.deleted<>1 AND tx_ligestmembrelabo_EstMembreDe.idEquipe = tx_ligestmembrelabo_Equipe.uid AND tx_ligestmembrelabo_Equipe.deleted<>1";
					$membres_groupBy = "";
					$membres_orderBy = "";
					$membres_limit = "";

					$membres_res = $GLOBALS['TYPO3_DB']->exec_SELECTquery($membres_select_fields, $membres_from_table, $membres_where_clause, $membres_groupBy, $membres_orderBy, $membres_limit);


					if($membres_row = $GLOBALS['TYPO3_DB']->sql_fetch_assoc($membres_res)){
					$idEquipe = $membres_row['uidequipe'];
						...
						//Configuration du lien PageWeb
							...
							// configure typolink
							$temp_conf = $this->typolink_conf;
							$temp_conf['parameter'] = $membres_row['PageWeb'];
							$temp_conf['extTarget'] = '';				
							$temp_conf['parameter.']['wrap'] = "|";
							// Fill wrapped subpart marker
						$wrappedSubpartContentArray_publications_par_titres_auteurs['###Auteurs_PageWebLien###'] = $this->local_cObj->typolinkWrap($temp_conf);
						
						$markerArray_publications_par_titres_auteurs['###Auteurs_PageWeb###'] = $membres_row['PageWeb'];

						if($membres_row['PageWeb']<>''){
					...
					{
						$wrappedSubpartContentArray_publications_par_titres_auteurs['###Auteurs_PageWebLien###'] = '';
						$markerArray_publications_par_titres_auteurs['###Auteurs_PageWeb###'] = '';
						$markerArray_publications_par_titres_auteurs['###Auteurs_PageWeb_Separateur###'] = '';
					}
		...
		while($row_annee = $GLOBALS['TYPO3_DB']->sql_fetch_assoc($annee_res)){
			...
			while($row = $GLOBALS['TYPO3_DB']->sql_fetch_assoc($res_annees)){
				...
				if($row['EstInternationale']=='N'){
					...
					$markerArray_publications_par_annees_publications['###EstInternationale###'] = $this->lConf['EstInternationaleFrancophone'];
				...
				if($row['EstParu']=='E'){
					$markerArray_publications_par_annees_publications['###EstParu###'] = $this->lConf['EnCoursDeParution'];
				...
				if($row['TypeContribution']=='E'){
					$markerArray_publications_par_annees_publications['###TypeContribution###'] = $this->lConf['TypeContributionE'];
					
					if($this->lConf['TypeContributionE']<>''){
						$markerArray_publications_par_annees_publications['###TypeContribution_Separateur###'] = $this->lConf['TypeContribution_Separateur'];
					}
					else{
						$markerArray_publications_par_annees_publications['###TypeContribution_Separateur###'] = '';
					}
				}
				else{
					$markerArray_publications_par_annees_publications['###TypeContribution###'] = $this->lConf['TypeContributionP'];
				...
				$markerArray_publications_par_annees_publications['###TitreSupport###'] = $row['TitreSupport'];
				if($row['TitreSupport']<>''){
					$markerArray_publications_par_annees_publications['###TitreSupport_Separateur###'] = $this->lConf['TitreSupport_Separateur'];
				}
				else{
					$markerArray_publications_par_annees_publications['###TitreSupport_Separateur###'] = '';
				}
				...
				$markerArray_publications_par_annees_publications['###DOI###'] = $row['DOI'];
				if($row['DOI']<>''){
					$markerArray_publications_par_annees_publications['###DOI_Separateur###'] = $this->lConf['DOI_Separateur'];
				}
				else{
					$markerArray_publications_par_annees_publications['###DOI_Separateur###'] = '';
				}
				...
				if($row['TauxAcceptation']<>''){
					$markerArray_publications_par_annees_publications['###TauxAcceptation###'] = $row['TauxAcceptation'].'%';
					$markerArray_publications_par_annees_publications['###TauxAcceptation_Separateur###'] = $this->lConf['TauxAcceptation_Separateur'];
				}
				else{
					$markerArray_publications_par_annees_publications['###TauxAcceptation###'] = '';
					$markerArray_publications_par_annees_publications['###TauxAcceptation_Separateur###'] = '';
				}
...
/*
					...
					*/
						...
						$idEquipe = $membres_row['uidequipe'];
							...
							$markerArray_publications_par_annees_auteurs['###Auteurs_PageWeb###'] = $membres_row['PageWeb'];
						...
						{
							$wrappedSubpartContentArray_publications_par_annees_auteurs['###Auteurs_PageWebLien###'] = '';
							$markerArray_publications_par_annees_auteurs['###Auteurs_PageWeb###'] = '';
							$markerArray_publications_par_annees_auteurs['###Auteurs_PageWeb_Separateur###'] = '';
						}
